...
class PatrimonioList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Código do Patrimônio:", null, '14px', null, '100%'),$CodigodoPatrimonio]);
        ...
        $this->datagrid->addColumn($column_CodigodoPatrimonio);
        $this->datagrid->addColumn($column_ativo);
        $this->datagrid->addColumn($column_descricao);
        $this->datagrid->addColumn($column_responsavel);
        $this->datagrid->addColumn($column_ValorOriginal);
        $this->datagrid->addColumn($column_DataEntrada);
        $this->datagrid->addColumn($column_ValorAtual);

        $action_onEdit = new TDataGridAction(array('PatrimonioForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('PatrimonioList', 'onDelete'));
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Geral","Patrimonios"]));
        }
