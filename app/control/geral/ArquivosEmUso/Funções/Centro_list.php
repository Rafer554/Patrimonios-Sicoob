...
class Centro_list extends TPage{
    private $form;
    private $datagrid;
    ...
    public function __construct($param){
        ...
        $this->form->setFormTitle("Listagem Centro de Custo");

        

        $CentrodeCusto = new TEntry('CentroCusto');
            $CentrodeCusto->setSize('35%');

            $row1 = $this->form->addFields([new TLabel("Centro de Custo:", null, '14px', null)],[$CentrodeCusto]);
        ...
        $column_CentroCusto = new TDataGridColumn('CentroCusto', 'Descricao', 'left');
        $column_Descricao = new TDataGridColumn('Descricao', 'Local', 'left');
        ...
        $grid2 = $this->datagrid->addColumn($column_CentroCusto);
        ...
        $action_onDelete = new TDataGridAction(array('Centro_list', 'onDelete'));
    ...
    public function onReload($param=null){
        try {
            ...
            $repository = new TRepository('centrodecusto');
    ...
    public function onSearch($param = null) {
        ...
        if (isset($data->CentroCusto) && ((is_scalar($data->CentroCusto) && $data->CentroCusto !== '') || (is_array($data->CentroCusto) && !empty($data->CentroCusto)))) {
            // Cria o filtro para o campo 'Local'
            $filters[] = new TFilter('CentroCusto', 'like', "%{$data->CentroCusto}%");
        }
