...
class TipoBaixa extends TRecord
{
    const TABLENAME  = 'tipo_baixa';
    const PRIMARYKEY = 'id';
    ...
    public function getPatrimonios()
    {
        ...
        $criteria->add(new TFilter('tido_baixa_id', '=', $this->id));
    ...
    public function get_Patrimonio_Grupo_to_string()
    {
        ...
        $values = Patrimonio::where('tido_baixa_id', '=', $this->id)->getIndexedArray('Grupo_id','{Grupo->id}');
    ...
    public function get_Patrimonio_tido_baixa_to_string()
    {
        ...
        $values = Patrimonio::where('tido_baixa_id', '=', $this->id)->getIndexedArray('tido_baixa_id','{tido_baixa->id}');
        return implode(', ', $values);
    }
